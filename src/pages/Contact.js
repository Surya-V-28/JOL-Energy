...
const Contact = () => {
  useDocTitle("JOL Energy- Send us a message");
  ...
  return (
    <>
      ...
      <div
        id="contact"
        className="flex flex-col items-center mt-8 w-full  bg-[#0d141a] py-12 lg:py-24"
      >
        <div className="container mx-auto px-4 lg:px-20">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 mt-12">
            <div className="w-full lg:w-1/2 bg-gray-900 rounded-2xl p-6 text-white">
              ...
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    VIT Vellore, Vellore District, Tamil Nadu, India - 632014
                  </p>
                </div>
              </div>
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Tel: 9025108037</p>
                </div>
              </div>
          ...
          <form onSubmit={sendEmail} className="w-full lg:w-1/2 mx-auto">
            <div className="bg-white p-8 my-4 rounded-2xl shadow-2xl">
              <div className="flex justify-center">
                <h1 className="font-bold text-center text-black uppercase text-4xl">
                  Send us a message
                </h1>
              </div>
              ...
              <div className="my-2">
                <button
                  type="submit"
                  id="submitBtn"
                  className="uppercase text-sm font-bold tracking-wide bg-[#fdcb0a] hover:bg-white text-black p-3 rounded-lg w-full focus:outline-none focus:shadow-outline transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg"
                >
                  Send Message
                </button>
              </div>
